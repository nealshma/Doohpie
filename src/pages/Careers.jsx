...
const tags = ['Creative', 'Data', 'Delivery', 'Strategy', 'Tech']
              ...
              <div className="careerhero_component">
                <div className="margin-bottom margin-medium">
                  <h1 className="heading-style-h2 text-weight-normal is-not-capitalized">
                    At Doohpie, we're not just about creating exceptional brand content - we're about building a buzzing community of passionate, creative, and innovative individuals. Collaboration is our secret sauce, and every team member plays a vital role in shaping our unique culture and success.
                  </h1>
                </div>
              </div>
            </div>
          ...
          <div className="container-large">
            <div className="padding-section-small padding-bottom-0">
              <div className="career_component">
                ...
                <div className="margin-bottom margin-large text-align-center">
                  <p className="text-size-xxlarge text-weight-medium">JOIN OUR GANG</p>
                </div>
