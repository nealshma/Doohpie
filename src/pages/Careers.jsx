...
const tags = ['Engineering', 'Sales', 'Operations', 'Design', 'Data']
        ...
        <div className="padding-global">
          <div className="container-large">
            <div className="padding-section-small">
              <div className="careerhero_component">
                <div className="margin-bottom margin-medium">
                  <h1 className="heading-style-h2 text-weight-normal is-not-capitalized">
                    At Doohpie, we're building the platform that turns every location into an advertising opportunity. Geo-targeting, outdoor inventory and campaign delivery come together here - and it takes curious, ambitious people to make it happen. Collaboration is our secret sauce, and every team member plays a vital role in shaping our product and success.
                  </h1>
                </div>
              </div>
            </div>
          ...
          <div className="container-large">
            <div className="padding-section-small padding-bottom-0">
              <div className="career_component">
                <div className="margin-bottom margin-large text-align-center">
                  <img src={assets.svgs.opportunities} loading="lazy" alt="" className="opportunity_heading" />
                </div>

                <div className="job-nav-wrapper">
                  <div className="tag-grid">
                    {tags.map((tag) => (
                      <div
                        key={tag}
                        className={`career-checkbox-wrapper ${selectedTags.includes(tag) ? 'selected-tag' : ''}`}
                ...
                <div className="margin-bottom margin-large text-align-center">
                  <p className="text-size-xxlarge text-weight-medium">JOIN OUR TEAM</p>
                </div>

                <div className="margin-bottom margin-large">
                  <div className="empty-state">
                    <h1 className="heading-style-h2 text-weight-normal is-not-capitalized">
                      We're currently not hiring - check back soon for new openings!
                    </h1>
                  </div>
                </div>
              </div>
