...
const platformChoices = ['Static Billboard', 'Digital LED Board', 'Backlit Display', 'Construction Cover', 'Not sure yet']
const followerRanges = ['1-2 weeks', '2-4 weeks', '1-3 months', '3+ months']
const categories = ['BRAND AWARENESS', 'PRODUCT LAUNCH', 'RETAIL PROMOTION', 'EVENT PROMOTION', 'LOCAL REACH', 'POLITICAL & PUBLIC', 'AUTOMOTIVE', 'FMCG', 'FASHION', 'REAL ESTATE', 'ENTERTAINMENT', 'OTHER']
          ...
          <div className="container-large">
            <div className="padding-section-small">
              <p className="text-size-huge">
                You don't need the biggest budget to own the right location. Whether you're launching a single store or planning a multi-city takeover, Doohpie helps you define your target area, discover inventory and launch geo-targeted outdoor campaigns. Tell us where you want to be seen - we'll handle the rest.
              </p>
            </div>
          </div>
        </div>
              ...
              <form onSubmit={handleSubmit}>
                    ...
                    <div className="contact-form_layout">
                      <div className="element-wraper">
                        <div>
                          ...
                          <p className="contact-intro">Every great outdoor campaign starts with a location. Tell us about yourself and where you want your brand to be seen.</p>
                        </div>
                      </div>
                ...
                {step === 2 && (
                  <div className="slide-contact">
                    ...
                    <div className="contact-form_layout">
                      <div className="element-wraper">
                        <div>
                          <p className="form-section-title">How long will your campaign run?</p>
                          <p className="contact-intro">Define your campaign duration and we'll match inventory availability across your target locations.</p>
                        </div>
                      </div>
                      <div className="contact-form form-slider">
                ...
                {step === 3 && (
                  <div className="slide-contact">
                    ...
                    <div className="contact-form_layout">
                      <div className="element-wraper">
                        <div>
                          <p className="form-section-title">What's your campaign objective?</p>
                          <p className="contact-intro">From brand awareness to local retail promotions - tell us what you want to achieve and we'll recommend the right formats.</p>
                        </div>
                      </div>
                ...
                {step === 4 && (
                  <div className="slide-contact">
                    ...
                    <div className="contact-form_layout">
                      <div>
                        <p className="form-section-title">Tell us about your campaign:</p>
                        <p className="contact-intro">Add any extra details - target radius, cities, preferred formats or campaign timing - and we'll come back with a plan.</p>
                      </div>
                      <div className="contact-form form-slider">
                        <textarea
